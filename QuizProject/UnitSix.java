...
public class UnitSix extends JPanel implements ActionListener {
    ...
    public UnitSix(ProjectWindow w) {
        window = w;
        setSize(800, 600);
        setLocation(0, 0);
        setLayout(null);
        ...
        unitName = new JLabel("Unit 6 (The last button clicked (A, B, C, D) is the answer choice that is saved.)");
    ...
    public void q1() {
        ...
        answerTextA.setText("17");
        answerTextB.setText("10");
        answerTextC.setText("7");
        answerTextD.setText("6");
    ...
    public void q2() {
        ...
        question.setWrapStyleWord(true);
        question.setText("Consider the following method that is intended to return the sum of the elements\nin the array key.\npublic static int sumArray(int[] key) {\n    int sum = 0;\n    for(int i = 1; i <= key.length; i++) {\n        /* missing code */\n    }\n    return sum;\n}\nWhich of the following statements should be used to replace /* missing code */\nso that sumArray will work as intended?");
        answerTextA.setText("sum += key[i - 1];");
        answerTextB.setText("sum = key[i];");
        answerTextC.setText("sum += sum + key[i - 1];");
        answerTextD.setText("sum += sum + key[i];");
        question.setBounds(50, 65, 500, 250);
        answerTextA.setBounds(110, 320, 400, 35);
        answerTextB.setBounds(110, 370, 400, 35);
        answerTextC.setBounds(110, 420, 400, 35);
