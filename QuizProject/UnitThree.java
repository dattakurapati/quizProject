...
public class UnitThree extends JPanel implements ActionListener {
    ...
    public UnitThree(ProjectWindow w) {
        window = w;
        setSize(800, 600);
        setLocation(0, 0);
        setLayout(null);
        ...
        unitName = new JLabel("Unit 3 (The last button clicked (A, B, C, D) is the answer choice that is saved.)");
    ...
    public void q1() {
        ...
        question.setText("public void test(int x) { \n    int y; \n    if(x % 2) == 0 { \n        y = 3; \n    else if(x > 9) { \n       y=5; \n    else { \n        y = 1; \n    System.out.println(\"y = \" + y) \n} \nWhich of the following test data set would test \neach possible output for the method?");

        answerTextA.setText("8, 9, 12");
        answerTextB.setText("7, 9, 11");
        answerTextC.setText("8, 9, 11");
        answerTextD.setText("8, 11, 13");
    ...
    public void q2() {
        ...
        question.setWrapStyleWord(true);
        question.setText("Assume that a and b have been defined and \n initialized as int values. The expression ! ( ! (a != b ) && (b > 7) ) \n is equivalent to which of the following?");
        answerTextA.setText("(a != b) || (b < 7)");
        answerTextB.setText("(a != b) || (b <= 7)");
        answerTextC.setText("(a == b) && (b <= 7)");
        answerTextD.setText("(a == b) && (b > 7)");
