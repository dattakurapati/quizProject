...
public class UnitOne extends JPanel implements ActionListener {
    ...
    public UnitOne(ProjectWindow w) {
        window = w;
        setSize(800, 600);
        setLocation(0, 0);
        setLayout(null);
        ...
        unitName = new JLabel("Unit 1 (The last button clicked (A, B, C, D) is the answer choice that is saved.)");
    ...
    public void q1() {
        ...
        question.setText("Which of the following is not a \n primitive data types?");

        answerTextA.setText("String");
        answerTextB.setText("int");
        answerTextC.setText("double");
        answerTextD.setText("boolean");
        question.setBounds(50, 65, 300, 60);
    ...
    public void q2() {
        ...
        question.setWrapStyleWord(true);
        question.setText("What is the max positive value of \n an int in java?");
        answerTextA.setText("32767");
        answerTextB.setText("429249001");
        answerTextC.setText("999999999");
        answerTextD.setText("2147483647");
        question.setBounds(50, 65, 300, 60);
        answerTextA.setBounds(110, 320, 400, 35);
        answerTextB.setBounds(110, 370, 400, 35);
        answerTextC.setBounds(110, 420, 400, 35);
