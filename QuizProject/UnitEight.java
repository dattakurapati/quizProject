...
public class UnitEight extends JPanel implements ActionListener {
    ...
    public UnitEight(ProjectWindow w) {
        window = w;
        setSize(800, 600);
        setLocation(0, 0);
        setLayout(null);
        ...
        unitName = new JLabel("Unit 8 (The last button clicked (A, B, C, D) the is answer choice that is saved.)");
    ...
    public void q1() {
        ...
        question.setText("int[] oldArray = {1, 2, 3, 4, 5, 6, 7, 8, 9}; \nint[][] newArray = new int[3][3];\nint row = 0;\nint col = 0;\nfor(int value : oldArray) {\n    newArray[row][col] = value;\n    row++\n    if((row % 3) == 0) {\n        col++;\n        row = 0;\n    }\n}\nSystem.out.println(Array[0][2]);\nWhat is printed as a result of executing the code segment?");

        answerTextA.setText("3");
        answerTextB.setText("4");
        answerTextC.setText("7");
        answerTextD.setText("8");
        question.setBounds(50, 65, 500, 255);
    ...
    public void q2() {
        ...
        question.setWrapStyleWord(true);
        question.setText("What is the output by the code below?\nint[][] mat = new int[10][10];\nfor(int i = 0; i < mat.length; i++)\n    for(int j = 0; j < mat[i].length; j++)\n        mat[i][j] = i*j;\nSystem.out.println(mat[9][9]);");
        answerTextA.setText("0");
        answerTextB.setText("9");
        answerTextC.setText("18");
        answerTextD.setText("81");
